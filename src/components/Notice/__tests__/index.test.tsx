...
describe('<Notice />', () => {
  it('should support link click', () => {
    const content = 'Hello zxuicn';
    const url = 'https://github.com/alibaba/zxuicn';
  ...
  it('should show more icon when content was more than two lines', () => {
    const content =
      'Hello zxuicn, Hello zxuicn, Hello zxuicn, Hello zxuicn, Hello zxuicn, Hello zxuicn, Hello zxuicn';
